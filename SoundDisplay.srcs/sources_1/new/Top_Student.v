...
module Top_Student (
   ...
   // assign oled_data = (sw[1] == 1) ? oled_data_volume : oled_data_menu;
    ...
    wire btnL_press, btnR_press, btnC_press, btnU_press;
//    wire btnL_press, btnR_press;
    single_pulse_circuit f2(clk20hz, btnC, btnC_press);
    single_pulse_circuit f3(clk20hz, btnL, btnL_press);
    single_pulse_circuit f4(clk20hz, btnR, btnR_press);
    single_pulse_circuit f10(clk20hz, btnU, btnU_press);
    //single pulse
  ...
  //  Volume_left_right f9 (clk381hz, btnL_press, btnR_press, btnC_press, btnL_count, btnR_count);
    ...
    //visualize (clk6p25m, mic_in, x, y, oled_data);    
    
    wire A, B, C, E, K, L, R;
    snake_signal (clk6p25m, clk20hz, btnU_press, btnL_press, btnR_press, K, L, R);
    snake_game (clk6p25m, clk20hz, L, R, K, x, y, oled_data); 
   ...
   // bouncing_ball_game (clk20hz, clk6p25m, btnU_press, btnL_press, btnR_press, x, y, oled_data);                       
